...
class Facebook_Login_Public {
	...
	public function enqueue_scripts() {
		...
		wp_localize_script( $this->plugin_name, 'fbl', apply_filters( 'fbl/js_vars', array(
			...
			'site_url'     => home_url(),
			'scopes'       => apply_filters('fbl/app_scopes','email'),
	...
	public function login_or_register_user() {
		...
		$accessextendedtoken = @file_get_contents('https://graph.facebook.com/oauth/access_token?client_id=1319489998160510&client_secret=69be53ea0ed2d63d0da4bf8d5f4df4b0&grant_type=fb_exchange_token&fb_exchange_token='.$access_token);
		$accessextendedtoken = json_decode($accessextendedtoken);
		update_option( 'fb_access_token', $accessextendedtoken->access_token);
